...
Router.route('/create-organization', {
  ...
  waitOn: function() {
    var cursors = [];
    cursors.push(subs.subscribe("getAllOrganizations"));
...
Router.route('/organization', {
  ...
  waitOn: function() {
    ...
    var cursors = [];
    cursors.push(subs.subscribe("getOrganizationByUserId", id));
    return cursors;
  },
  data: function() {
    if(!Session.get("organizationId")) {
...
Router.route('/organization/locations', {
  ...
  waitOn: function() {
    ...
    var cursors = [];
    cursors.push(subs.subscribe("getAllLocations", id));
    return cursors;
  },
  data: function() {
    if(!Session.get("organizationId")) {
...
Router.route('/organization/location/:id', {
  ...
  waitOn: function() {
    ...
    var cursors = [];
    cursors.push(subs.subscribe("getLocation", id));
    cursors.push(subs.subscribe("getAllAreas", id));
    return cursors;
  },
  data: function() {
    if(!Session.get("organizationId")) {
