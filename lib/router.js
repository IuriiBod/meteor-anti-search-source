...
Router.route('/suppleirOrder/:supplierId', {
  name: "suppleirOrdering",
  path: '/suppleirOrder/:supplierId',
  template: "supplierOrderingMainView",
  waitOn: function() {
    var cursors = [];
    // cursors.push(Meteor.subscribe("unAssignedJobs"));
    return cursors;
...
Router.route('/supplierOrderReceive/:supplierId', {
  name: "supplierOrderReceive",
  path: '/supplierOrderReceive/:supplierId',
  template: "supplierOrderReceiveMainView",
  waitOn: function() {
    var cursors = [];
    // cursors.push(Meteor.subscribe("unAssignedJobs"));
    return cursors;
